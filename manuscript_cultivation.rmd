...
bray_MediaXmuta.hel <- bray.MediaXmuta.hel + scale_colour_manual(values = c("royalblue4", "royalblue1","steelblue1")) + geom_point(size = 2) + theme_bw()
...
bray_MediaAsventres.hel <- bray.MediaAsventres.hel + scale_colour_manual(values = c("red4", "orangered")) + geom_point(size = 2) + theme_bw()
